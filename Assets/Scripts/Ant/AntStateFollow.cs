...
/*
 * klasa AntStateFollow dziedziczy od AntState i odpowiada za zachowanie mrowki w stanie podazania za punktami jedzenia
 */ 
public class AntStateFollow : AntState
{
    // metoda odpowiadajaca za obrot mrowki
